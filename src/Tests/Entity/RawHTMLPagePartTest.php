...
class RawHTMLPagePartTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertSame('KunstmaanPagePartBundle:RawHTMLPagePart:view.html.twig', $this->object->getDefaultView());
    }
    ...
    public function testSetGetContent()
    {
        ...
        $this->assertSame($this->object->getContent(), 'tèst content with s3ç!àL');
    }
    ...
    {
        $this->assertSame('Kunstmaan\PagePartBundle\Form\RawHTMLPagePartAdminType', $this->object->getDefaultAdminType());
    }
}
