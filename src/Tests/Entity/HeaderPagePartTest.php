...
class HeaderPagePartTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertSame('KunstmaanPagePartBundle:HeaderPagePart:view.html.twig', $this->object->getDefaultView());
    }
    ...
    {
        $this->assertSame('Kunstmaan\PagePartBundle\Form\HeaderPagePartAdminType', $this->object->getDefaultAdminType());
    }
}
