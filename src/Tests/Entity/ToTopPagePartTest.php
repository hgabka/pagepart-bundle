...
class ToTopPagePartTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertSame('KunstmaanPagePartBundle:ToTopPagePart:view.html.twig', $this->object->getDefaultView());
    }
    ...
    {
        $this->assertSame('Kunstmaan\PagePartBundle\Form\ToTopPagePartAdminType', $this->object->getDefaultAdminType());
    }
}
