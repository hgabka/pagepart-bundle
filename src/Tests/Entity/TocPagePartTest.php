...
class TocPagePartTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertSame('KunstmaanPagePartBundle:TocPagePart:view.html.twig', $this->object->getDefaultView());
    }
    ...
    {
        $this->assertSame('Kunstmaan\PagePartBundle\Form\TocPagePartAdminType', $this->object->getDefaultAdminType());
    }
}
