...
class TextPagePartTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertSame('KunstmaanPagePartBundle:TextPagePart:view.html.twig', $this->object->getDefaultView());
    }
    ...
    {
        $this->assertSame('Kunstmaan\PagePartBundle\Form\TextPagePartAdminType', $this->object->getDefaultAdminType());
    }
}
